...
public class PlayMusicOnErrorListener implements DexterousMediaPlayer.OnErrorListener {
     ...
     *                    <ul>
     *                    <li>{@link #MEDIA_ERROR_UNKNOWN} 1 Unspecified media player error.
     *                    <li>{@link #MEDIA_ERROR_SERVER_DIED} 100  Media server died.
     *                    </ul>
     * @param extra       an extra code, specific to the error. Typically
     *                    implementation dependent.
     *                    <ul>
     *                    <li>{@link #MEDIA_ERROR_IO} 1004 File or network related operation errors.
     *                    <li>{@link #MEDIA_ERROR_MALFORMED} 1007 Bitstream is not conforming to the related coding standard or file spec.
     *                    <li>{@link #MEDIA_ERROR_UNSUPPORTED} 1010  Bitstream is conforming to the related coding standard or file spec, but the media framework does not support the feature.
     *                    <li>{@link #MEDIA_ERROR_TIMED_OUT} 110 Some operation takes too long to complete, usually more than 3-5 seconds.
     *                    </ul>
