...
public class MusicDao extends AbstractDao<Music, String> {
    ...
    public static class Properties {
        ...
        public final static Property SONG_FILE_PATH = new Property(1, String.class, "SONG_FILE_PATH", false, "SONG__FILE__PATH");
        ...
        public final static Property SONG_YEAR = new Property(6, String.class, "SONG_YEAR", false, "SONG__YEAR");
        public final static Property SONG_TRACK_NUMBER = new Property(7, String.class, "SONG_TRACK_NUMBER", false, "SONG__TRACK__NUMBER");
        public final static Property SONG_IS_PLAYING = new Property(8, Boolean.class, "SONG_IS_PLAYING", false, "SONG__IS__PLAYING");
        public final static Property SONG_ALBUM_ARTIST = new Property(9, String.class, "SONG_ALBUM_ARTIST", false, "SONG__ALBUM__ARTIST");
        public final static Property SONG_GENRE = new Property(10, String.class, "SONG_GENRE", false, "SONG__GENRE");
        public final static Property SONG_PLAY_COUNT = new Property(11, String.class, "SONG_PLAY_COUNT", false, "SONG__PLAY__COUNT");
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"MUSIC\" (" + //
                ...
                "\"SONG__FILE__PATH\" TEXT," + // 1: SONG_FILE_PATH
                ...
                "\"SONG__YEAR\" TEXT," + // 6: SONG_YEAR
                "\"SONG__TRACK__NUMBER\" TEXT," + // 7: SONG_TRACK_NUMBER
                "\"SONG__IS__PLAYING\" INTEGER," + // 8: SONG_IS_PLAYING
                "\"SONG__ALBUM__ARTIST\" TEXT," + // 9: SONG_ALBUM_ARTIST
                "\"SONG__GENRE\" TEXT," + // 10: SONG_GENRE
                "\"SONG__PLAY__COUNT\" TEXT," + // 11: SONG_PLAY_COUNT
    ...
    protected final void bindValues(DatabaseStatement stmt, Music entity) {
        ...
        if (SONG_FILE_PATH != null) {
            stmt.bindString(2, SONG_FILE_PATH);
        }
    ...
    public Music readEntity(Cursor cursor, int offset) {
        Music entity = new Music( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // SONG_FILE_PATH
            ...
            cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6), // SONG_YEAR
            cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7), // SONG_TRACK_NUMBER
            cursor.isNull(offset + 8) ? null : cursor.getShort(offset + 8) != 0, // SONG_IS_PLAYING
            cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9), // SONG_ALBUM_ARTIST
            cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10), // SONG_GENRE
            cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11), // SONG_PLAY_COUNT
    ...
    public void readEntity(Cursor cursor, Music entity, int offset) {
        ...
        entity.setSONG_FILE_PATH(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
        ...
        entity.setSONG_YEAR(cursor.isNull(offset + 6) ? null : cursor.getString(offset + 6));
        entity.setSONG_TRACK_NUMBER(cursor.isNull(offset + 7) ? null : cursor.getString(offset + 7));
        entity.setSONG_IS_PLAYING(cursor.isNull(offset + 8) ? null : cursor.getShort(offset + 8) != 0);
        entity.setSONG_ALBUM_ARTIST(cursor.isNull(offset + 9) ? null : cursor.getString(offset + 9));
        entity.setSONG_GENRE(cursor.isNull(offset + 10) ? null : cursor.getString(offset + 10));
        entity.setSONG_PLAY_COUNT(cursor.isNull(offset + 11) ? null : cursor.getString(offset + 11));
