package music.dexterous.com.dexterousmusic.animations.transformation;
...
public abstract class ABaseTransformer implements ViewPager.PageTransformer {
    ...
    /**
     * Called each {@link #transformPage(android.view.View, float)} before {{@link
    ...
    /**
     * Called each {@link #transformPage(android.view.View, float)} after {@link
     * #onTransform(android.view.View, float)}.
     *
     * @param page     Apply the transformation to this page
     * @param position Position of page relative to the current front-and-center position of the
