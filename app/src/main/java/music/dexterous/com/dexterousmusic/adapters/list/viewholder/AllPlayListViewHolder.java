...
public class AllPlayListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    public ImageView mTextView;
    public FontTextView albumName;
    private AllPlayListAdapter.OnAlbumItemClickListener mOnClickListener;


    public AllPlayListViewHolder(View itemView, AllPlayListAdapter.OnAlbumItemClickListener onClickListener) {
        super(itemView);
