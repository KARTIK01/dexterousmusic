...
import music.dexterous.com.dexterousmusic.customeviews.bounce.adapter.AbsListViewOverScrollDecorAdapter;
import music.dexterous.com.dexterousmusic.customeviews.bounce.adapter.HorizontalScrollViewOverScrollDecorAdapter;
import music.dexterous.com.dexterousmusic.customeviews.bounce.adapter.RecyclerViewOverScrollDecorAdapter;
import music.dexterous.com.dexterousmusic.customeviews.bounce.adapter.ScrollViewOverScrollDecorAdapter;
import music.dexterous.com.dexterousmusic.customeviews.bounce.adapter.StaticOverScrollDecorAdapter;
import music.dexterous.com.dexterousmusic.customeviews.bounce.adapter.ViewPagerOverScrollDecorAdapter;
...
public class OverScrollDecoratorHelper {
    ...
    /**
     * Set up the over-scroll effect over a specified {@link RecyclerView} view. <br/>Only
     * recycler-views using <b>native</b> Android layout managers (i.e. {@link LinearLayoutManager},
     * {@link GridLayoutManager} and {@link StaggeredGridLayoutManager}) are currently supported by
    ...
    /**
     * Set up the over-scroll over a generic view, assumed to always be over-scroll ready (e.g. a
     * plain text field, image view).
     *
     * @param view        The view.
